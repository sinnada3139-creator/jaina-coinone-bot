...
OFFICIAL_PROJECT_SOURCES={
 "WLD":[("World Official","https://world.org/"),("World Updates","https://world.org/news")],
...
def official_news_text():
    parts=["🏢 【WLD·KAIA 공식뉴스 레이더 v17.15】",
...
def catalyst_score_item(item):
    ...
    return pos*2 + bridge_bonus + source_weight(item.get("source")) - risk*2
