...
def _clarity_official_rows():
    ...
    for source,url in CLARITY_OFFICIAL_SOURCES:
        try:
            r=SESSION.get(url,timeout=(3.0,8.0),headers={'User-Agent':'Mozilla/5.0 JainaCoinMonitor/17.7'})
...
def clarity_radar_text():
    parts=['🏛️ 【CLARITY Act 전용 레이더 v17.7】','H.R. 3633 · 미 상원 시장구조 법안 집중감시','공식 상원자료 → Reuters/주요언론 → 다중 RSS 교차확인']
