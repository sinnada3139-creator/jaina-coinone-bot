import os, time, threading, requests, html
    ...
    while True:
        ...
        for u in r.get("result",[]):
            ...
            if text.startswith("/start") or text.lower()=="start":
                send("✅ Jaina Coin Monitor v8 연결 완료\n/status 현재상태\n/news 최신 크립토·KAIA·WLD 뉴스\n/market BTC 시장요약\n/test 알림테스트\n\n뉴스 브리핑은 2시간마다 자동 발송\n※ 자동주문 없음",cid)
...
<div class="w"><h2>자이나 코인원 감시봇 v8</h2><small>WLD · KAIA / 전략 신호 + 뉴스 / 자동주문 없음</small><div id="x"></div></div>
<script>
