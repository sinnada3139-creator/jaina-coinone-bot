...
BOT_VERSION = "15.5"
CAUSE_ENGINE = "EVENT-CLUSTER-DIAG-v5"
...
def market_cause_analysis_text(force_direction=None):
    ...
    parts=[f"🌐 【현재 시장 {label} 원인 분석 v15.5】",f"🧠 원인엔진 {CAUSE_ENGINE}",f"BTC {btcprice:,.0f}원 · 1분 {btc1:+.2f}% · 5분 {btc5:+.2f}% · 당일 기준 {btc24:+.2f}%",""]
    ...
    if not selected:
        ...
        parts += [f"🧪 v15.5 진단: GEO {dc['GEO']} · OIL {dc['OIL']} · RATE {dc['RATE']} · RISK {dc['RISK']}"]
        parts += dr
        parts.append("")
